...
module.exports = {
    ...
    'Pará': function(test){
        test.ok(['15.207.186-5', '15.230.079-1', '15.230.078-3',
                 ...
                 '79.789.012-2',
                 '79.012.345-2',
                ].every(function(ie){ return inscricaoEstadual(ie, 'pa'); }));
    ...
    'Goiás': function(test){
        test.ok(['103010068', '100549365', '102082073',
                 ...
                 '104787910', '105.14336-7', '152661743',
                 '200752715', '202159582', '202209288'].every(function(ie){ return inscricaoEstadual(ie, 'go'); }));
